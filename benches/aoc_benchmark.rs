...
use adventofcode::y2025::day01::day01;
use adventofcode::y2025::day02::day02;
use adventofcode::y2025::day03::day03;
use adventofcode::y2025::day04::day04;
use adventofcode::y2025::day05::day05;
use adventofcode::y2025::day06::day06;
use adventofcode::y2025::day07::day07;
use adventofcode::y2025::day08::day08;
use adventofcode::y2025::day09::day09;
use adventofcode::y2025::day10::day10;
use adventofcode::y2025::day11::day11;
use adventofcode::y2025::day12::day12;
...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("2025 day 01", |b| b.iter(|| day01(|_| {})));
    c.bench_function("2025 day 02", |b| b.iter(|| day02(|_| {})));
    c.bench_function("2025 day 03", |b| b.iter(|| day03(|_| {})));
    c.bench_function("2025 day 04", |b| b.iter(|| day04(|_| {})));
    c.bench_function("2025 day 05", |b| b.iter(|| day05(|_| {})));
    c.bench_function("2025 day 06", |b| b.iter(|| day06(|_| {})));
    c.bench_function("2025 day 07", |b| b.iter(|| day07(|_| {})));
    c.bench_function("2025 day 08", |b| b.iter(|| day08(|_| {})));
    c.bench_function("2025 day 09", |b| b.iter(|| day09(|_| {})));
    c.bench_function("2025 day 10", |b| b.iter(|| day10(|_| {})));
    c.bench_function("2025 day 11", |b| b.iter(|| day11(|_| {})));
    c.bench_function("2025 day 12", |b| b.iter(|| day12(|_| {})));
}
