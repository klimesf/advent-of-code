...
pub(crate) fn day13() {
    println!(
        "{}",
        part_a(fs::read_to_string("input/2020/day13/input.txt").unwrap())
    );
    println!(
        "{}",
        part_b(fs::read_to_string("input/2020/day13/input.txt").unwrap())
    );
}
...
mod day13_tests {
    ...
    fn test_works() {
        assert_eq!(
            295,
            part_a(fs::read_to_string("input/2020/day13/test.txt").unwrap())
        );
        assert_eq!(
            1068781,
            part_b(fs::read_to_string("input/2020/day13/test.txt").unwrap())
        );
    }
