...
pub(crate) fn day05() {
    println!(
        "{}",
        part_a(fs::read_to_string("input/2020/day05/input.txt").unwrap())
    );
    println!(
        "{}",
        part_b(fs::read_to_string("input/2020/day05/input.txt").unwrap())
    );
}
...
mod day05_tests {
    ...
    fn test_works() {
        assert_eq!(
            820,
            part_a(fs::read_to_string("input/2020/day05/test.txt").unwrap())
        );
    }
