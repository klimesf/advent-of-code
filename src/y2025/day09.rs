...
pub(crate) fn day09(print: fn(usize)) {
    print(part_a(
        fs::read_to_string("input/2025/day09/input.txt").unwrap(),
    ));
    print(part_b(
        fs::read_to_string("input/2025/day09/input.txt").unwrap(),
    ));
...
mod day09_tests {
    ...
    fn test_works() {
        assert_eq!(
            50,
            part_a(fs::read_to_string("input/2025/day09/test.txt").unwrap())
        );
        assert_eq!(
            24,
            part_b(fs::read_to_string("input/2025/day09/test.txt").unwrap())
        );
    }
    ...
    fn input_works() {
        assert_eq!(
            4782151432,
            part_a(fs::read_to_string("input/2025/day09/input.txt").unwrap())
        );
        assert_eq!(
            1450414119,
            part_b(fs::read_to_string("input/2025/day09/input.txt").unwrap())
        );
    }
}
