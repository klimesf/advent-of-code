...
fn part_a(input: String) -> usize {
    let mut bricks: Vec<((i32, i32, i32), (i32, i32, i32))> = input.lines().map(|line| {
    ...
    bricks.sort_by(|a, b| {
        if a.0.2 == b.0.2 { a.1.2.cmp(&b.1.2) } else { a.0.2.cmp(&b.0.2) }
    });
    ...
    for _i in 0..settled_bricks.len() {
        let bricks_without_i: Vec<((i32, i32, i32), (i32, i32, i32))> = settled_bricks.iter().enumerate()
            .filter(|(j, _)| *j != _i)
            .map(|(_, b)| *b).collect();
...
fn settle(bricks_input: &Vec<((i32, i32, i32), (i32, i32, i32))>) -> (Vec<((i32, i32, i32), (i32, i32, i32))>, usize, usize) {
    ...
    loop {
        ...
        for bi in 0..bricks.len() {
            ...
            for dz in 1..z1 {
                ...
                if !collision { z_fall = dz } else { break; };
            }
