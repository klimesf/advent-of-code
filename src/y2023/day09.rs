...
pub(crate) fn day09() {
    println!("{}", part_a(fs::read_to_string("input/2023/day09/input.txt").unwrap()));
    println!("{}", part_b(fs::read_to_string("input/2023/day09/input.txt").unwrap()));
}
...
mod day09_tests {
    ...
    #[test]
    fn test_works() {
        assert_eq!(114, part_a(fs::read_to_string("input/2023/day09/test.txt").unwrap()));
        assert_eq!(2, part_b(fs::read_to_string("input/2023/day09/test.txt").unwrap()));
    }

    #[test]
    fn input_works() {
        assert_eq!(1974913025, part_a(fs::read_to_string("input/2023/day09/input.txt").unwrap()));
        assert_eq!(884, part_b(fs::read_to_string("input/2023/day09/input.txt").unwrap()));
    }
}
