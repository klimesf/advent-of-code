...
pub fn day04(print: fn(usize)) {
    print(part_a(fs::read_to_string("input/2024/day04/input.txt").unwrap()));
    print(part_b(fs::read_to_string("input/2024/day04/input.txt").unwrap()));
}
...
fn part_a(input: String) -> usize {
    ...
    for x in 0..map.len() {
        for y in 0..map[0].len() {
            ...
            // Right
            if y <= map[x].len() - 4 && map[x][y + 1] == 'M' && map[x][y + 2] == 'A' && map[x][y + 3] == 'S' {
                ans += 1;
            }
            ...
            // Down
            if x <= map[x].len() - 4 && map[x + 1][y] == 'M' && map[x + 2][y] == 'A' && map[x + 3][y] == 'S' {
                ans += 1;
            }
            ...
            // Left + Up
            if y >= 3 && x >= 3 && map[x - 1][y - 1] == 'M' && map[x - 2][y - 2] == 'A' && map[x - 3][y - 3] == 'S' {
                ans += 1;
            }
        }
    }
...
fn part_b(input: String) -> usize {
    ...
    for x in 0..map.len() {
        for y in 0..map[0].len() {
            ...
            if x < 1 || y < 1 || x > map[x].len() - 2 || y > map.len() - 2 {
                continue;
            }
