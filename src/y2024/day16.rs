...
fn part_b(input: String) -> usize {
    ...
    while let Some(pos) = stack.pop() {
        ...
        if map[pos.coords()] == b'E' {
            distances[pos.x as usize][pos.y as usize][pos.dir] =
                distances[pos.x as usize][pos.y as usize][pos.dir].min(pos.dist);
        ...
        if distances[pos.x as usize][pos.y as usize][pos.dir] < pos.dist {
            continue;
        }
        distances[pos.x as usize][pos.y as usize][pos.dir] =
            distances[pos.x as usize][pos.y as usize][pos.dir].min(pos.dist);
